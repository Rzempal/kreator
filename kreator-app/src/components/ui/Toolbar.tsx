// src/components/ui/Toolbar.tsx v0.002 Pasek narzedzi z historia rozmiarow
'use client';

import { useKreatorStore, useRecentSizes, useToolMode } from '@/store/useKreatorStore';
    ...
    <div className="flex flex-wrap items-center gap-2 p-3 bg-slate-800/80 backdrop-blur-md rounded-xl border border-slate-700">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          title="Gumka - kliknij panel aby go usunac"
        >
